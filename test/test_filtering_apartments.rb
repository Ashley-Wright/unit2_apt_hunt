...
class TestFilteringApartments < AptHuntTest
  def test_filtering_apt_by_rent
    ...
    apartment1 = Apartment.create(rent: 983.57, size: 1474, bedrooms: 3, bathrooms: 1.5, apartmentcomplex_id: complex1.id)
    apartment2 = Apartment.create(rent: 883.57, size: 1474, bedrooms: 3, bathrooms: 1.5, apartmentcomplex_id: complex1.id)
